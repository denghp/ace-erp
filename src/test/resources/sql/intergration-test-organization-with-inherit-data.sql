...
--组织机构单独授权
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `role_ids`, `type`)
    values(1, 1, 0, 0, '2', 'organization_job');
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `role_ids`, `type`)
    values(2, 2, 0, 0, '1', 'organization_job');
insert into sys_auth (`id`, `organization_id`, `job_id`, `user_id`, `role_ids`, `type`)
    values(3, 3, 0, 0, '3', 'organization_job');
