...
ace.handler_side_click_menu = function(a) {
    ...
    a(".nav-list").on(ace.click_event, function (h) {
        ...
        if (!g.hasClass("dropdown-toggle")) {
            if (c && ace.click_event == "tap" && g.get(0).parentNode.parentNode == this) {
                ...
                if (a(this).find("> .open")) {
                    a(this).find("> .open").removeClass("open")
                    a(this).find("> .active").removeClass("active");
                }
//                if(a(this).children(this).hasClass("active")) {
//                    a(this).children(this).removeClass("active");
//                }
//                if (a(this).find("> .open ")) {
//                    a(this).find("> .open").removeAttribute("class");
//                }
                a(g.get(0).parentNode).siblings().removeClass("active")
                a(g.get(0).parentNode).addClass("active");

                a(this).find("> .open").addClass("active")
                a(g.get(0).parentNode.parentNode.parentNode).addClass("active");
                //if (a(g.get(0).parentNode.parentNode)
                //a(g.get(0).parentNode.parentNode.parentNode).addClass("active");
            }
            if (b) {
